...
const COMPONENT_CATEGORIES = [
  ...
  },
  {
    ...
    title: 'Layout',
    description: 'Sidebar, NavigationMenu, Breadcrumb, Separator, Resizable, ScrollArea, AspectRatio, Collapsible.',
    count: 8,
  },
  {
  ...
  },
  {
    icon: MonitorIcon,
    title: 'Data Display',
    description: 'Table, Card, Badge, Avatar, Tabs, Accordion, Chart, Carousel, Pagination, Item, Kbd.',
    count: 11,
  },
  {
    icon: SparklesIcon,
...
const FEATURES = [
  ...
  },
  {
    icon: PaletteIcon,
    title: 'Themeable',
    description: '22 color themes with light & dark mode support. CSS custom properties make customization effortless.',
  },
  {
    icon: ZapIcon,
    title: 'Performant',
  ...
  },
  {
    ...
    title: 'Accessible',
    description: 'Built on Radix UI primitives with full WAI-ARIA compliance and keyboard navigation.',
  },
  {
    icon: BrushIcon,
    title: 'Tailwind CSS v4',
    description: 'First-class Tailwind CSS v4 integration with tailwind-variants for type-safe styling.',
  },
  {
    icon: BlocksIcon,
    title: 'Composable',
    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative overflow-hidden border-b px-6 py-24 md:py-32">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="text-muted-foreground mx-auto mb-4 max-w-2xl text-xl leading-relaxed md:text-2xl">
            A modern, accessible, and beautifully crafted React component library built with Radix UI and Tailwind CSS.
          </p>

          <p className="text-muted-foreground/80 mx-auto mb-10 max-w-xl text-base">
            62 component modules. 6 custom hooks. 22 color themes. Dark mode. Full TypeScript support. Designed for the
            modern web.
          </p>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        <div className="mb-12 text-center">
          <h2 className="text-foreground mb-3 text-3xl font-bold tracking-tight">Get Started in Seconds</h2>
          <p className="text-muted-foreground text-lg">Install the package and start building beautiful interfaces.</p>
        </div>

        <div className="mx-auto max-w-xl space-y-4">
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm font-medium">1. Install the package</p>
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm font-medium">2. Import the styles</p>
            <div className="bg-muted/50 space-y-1 rounded-lg border px-4 py-3 font-mono text-sm">
              <div className="text-muted-foreground">{'/* globals.css */'}</div>
              <div>
                <span className="text-blue-600 dark:text-blue-400">@import</span>{' '}
                <span className="text-green-600 dark:text-green-400">&apos;@codefast/ui/css/preset.css&apos;</span>;
              </div>
              <div>
                <span className="text-blue-600 dark:text-blue-400">@import</span>{' '}
                <span className="text-green-600 dark:text-green-400">&apos;@codefast/ui/css/neutral.css&apos;</span>;
              </div>
            </div>
          </div>

          <div className="space-y-2">
            <p className="text-muted-foreground text-sm font-medium">3. Use the components</p>
            <div className="bg-muted/50 space-y-1 rounded-lg border px-4 py-3 font-mono text-sm">
              <div>
                <span className="text-blue-600 dark:text-blue-400">import</span>
                {' { Button } '}
                <span className="text-blue-600 dark:text-blue-400">from</span>{' '}
                <span className="text-green-600 dark:text-green-400">&apos;@codefast/ui/button&apos;</span>;
              </div>
              <div className="mt-2">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:py-24">
        <div className="mb-12 text-center">
          <h2 className="text-foreground mb-3 text-3xl font-bold tracking-tight">Why @codefast/ui?</h2>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((feature) => (
            <Card key={feature.title} className="bg-card/50 border transition-colors hover:border-blue-500/30">
              <CardHeader>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:py-24">
        <div className="mb-12 text-center">
          <h2 className="text-foreground mb-3 text-3xl font-bold tracking-tight">Component Library</h2>
          <p className="text-muted-foreground text-lg">A rich set of components organized into intuitive categories.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {COMPONENT_CATEGORIES.map((category) => (
            <Card
              key={category.title}
              className="group bg-card/50 cursor-default border transition-all hover:border-purple-500/30 hover:shadow-md"
            >
              <CardContent className="flex items-start gap-4 p-5">
                ...
                <div className="min-w-0 flex-1">
                  <div className="mb-1 flex items-center gap-2">
                    <h3 className="text-foreground text-sm font-semibold">{category.title}</h3>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        <div className="mb-12 text-center">
          <h2 className="text-foreground mb-3 text-3xl font-bold tracking-tight">Theming Made Simple</h2>
          <p className="text-muted-foreground text-lg">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        <div className="mb-12 text-center">
          <h2 className="text-foreground mb-3 text-3xl font-bold tracking-tight">Built On Modern Foundations</h2>
          <p className="text-muted-foreground text-lg">Standing on the shoulders of best-in-class libraries.</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          {[
            ...
            <div
              key={tech.name}
              className="bg-muted/30 hover:bg-muted/50 flex flex-col items-center rounded-xl border p-6 text-center transition-colors"
            >
              <span className="text-foreground mb-1 text-sm font-semibold">{tech.name}</span>
      ...
      <section className="border-t px-6 py-16 md:py-20">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-foreground mb-3 text-2xl font-bold tracking-tight">Ready to Build?</h2>
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Button asChild variant="ghost" size="lg" className="gap-2">
              <a href="https://github.com/codefastlabs/codefast" target="_blank" rel="noopener noreferrer">
                GitHub
                <ArrowRightIcon className="size-4" />
              </a>
            </Button>
