...
/** The site page for a resolved `packages/<pkg>[/<path>]` path, or `null` when it is not a doc page. */
 ...
 * directory: a package document (or the package directory) becomes the site page, any other file a
 * GitHub `blob` link, and a directory a GitHub `tree` link — with the original `#hash` kept.
 */
