...
const translations: Translations<DataTableValues> = {
  en: {
    dir: "ltr",
    values: {
...
// Registered statically — the feature set is part of the table's type, not per-render state.
const features = tableFeatures({
  ...
  // Auto-detection resolves these by name; an unregistered name degrades silently in production.
        ...
        cell: ({ row }) => {
          ...
          return (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-40" data-lang={dir === "rtl" ? language : undefined}>
                <DropdownMenuGroup>
    ...
    <div className="w-full">
      <div className="flex items-center gap-2 py-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align={dir === "rtl" ? "start" : "end"} data-lang={dir === "rtl" ? language : undefined}>
            <DropdownMenuGroup>
              {table
                .getAllColumns()
      ...
      <div className="flex items-center justify-end gap-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          {table.getFilteredSelectedRowModel().rows.length} {t.rowsSelected} {table.getFilteredRowModel().rows.length}{" "}
          {t.rowsSelectedSuffix}
        </div>
