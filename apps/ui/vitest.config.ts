...
// Highlighting now lives behind the `getHighlightedSource` static server
// function; the registry tests call its impl (`highlight-source.impl`) directly,
// so no Shiki Vite plugin is needed here.
