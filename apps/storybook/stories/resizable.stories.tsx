...
export const Vertical: Story = {
  render: (args) => (
    <ResizablePanelGroup className="min-h-[12.5rem] max-w-md rounded-lg border" {...args} direction="vertical">
      <ResizablePanel defaultSize={25}>
        <div className="flex h-full items-center justify-center p-6">
...
export const Handle: Story = {
  render: (args) => (
    <ResizablePanelGroup className="min-h-[12.5rem] max-w-md rounded-lg border" {...args} direction="horizontal">
      <ResizablePanel defaultSize={25}>
        <div className="flex h-full items-center justify-center p-6">
