import { InputDefault } from "#/registry/input/default.example";
import { InputFile } from "#/registry/input/file.example";
import { InputStates } from "#/registry/input/states.example";
  ...
  examples: [
    {
      ...
      Demo: InputDefault,
      source: docSource("input", "default"),
    },
    {
      id: "states",
      title: "States",
