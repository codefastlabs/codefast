    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          description: "The dialog’s screen-reader-only title.",
        },
        {
          name: "description",
          type: "string",
          default: '"Search for a command to run..."',
          description: "The dialog’s screen-reader-only description.",
        },
        {
          name: "showCloseButton",
          type: "boolean",
          default: "false",
          description: "Renders the dialog’s corner × button.",
        },
        {
          name: "closeLabel",
          type: "string",
          default: '"Close"',
          description: "The accessible name of that × button.",
        },
      ],
    },
  ],
