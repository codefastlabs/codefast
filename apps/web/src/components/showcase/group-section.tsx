...
export function GroupSection({ group }: { group: ComponentGroup }) {
  return (
    <section id={group.id} className="mb-16 scroll-mt-28">
      <div className="mb-6 flex items-end justify-between gap-2 border-b border-ui-border bg-ui-bg/75 pt-3 pb-4 backdrop-blur-[20px] lg:sticky lg:top-12 lg:z-20">
