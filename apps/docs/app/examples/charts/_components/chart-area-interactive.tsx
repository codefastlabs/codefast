...
type ChartAreaInteractiveProps = Omit<ComponentProps<typeof Card>, 'children'>;

export function ChartAreaInteractive(props: ChartAreaInteractiveProps): JSX.Element {
      ...
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          ...
          <SelectContent className="">
            <SelectItem className="" value="90d">
              Last 3 months
            </SelectItem>
            <SelectItem className="" value="30d">
              Last 30 days
            </SelectItem>
            <SelectItem className="" value="7d">
              Last 7 days
            </SelectItem>
          </SelectContent>
        </Select>
