...
type ChartLineInteractiveProps = Omit<ComponentProps<typeof Card>, 'children'>;

export function ChartLineInteractive(props: ChartLineInteractiveProps): JSX.Element {
