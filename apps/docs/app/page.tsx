  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <header className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="bg-linear-to-t fixed bottom-0 left-0 flex h-48 w-full items-end justify-center from-white via-white lg:static lg:h-auto lg:w-auto lg:bg-none dark:from-black dark:via-black">
          <a
      ...
      <main className="grid place-items-center gap-4">
        <div className="before:bg-gradient-radial after:bg-gradient-conic dark:before:bg-linear-to-br relative z-[-1] flex place-items-center before:absolute before:h-[18.75rem] before:w-full before:-translate-x-1/2 before:rounded-full before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[11.25rem] after:w-full after:translate-x-1/3 after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] sm:before:w-[30rem] sm:after:w-[15rem] lg:before:h-[22.5rem] dark:before:from-transparent dark:before:to-blue-700 dark:before:opacity-10 dark:after:from-sky-900 dark:after:via-[#0141ff] dark:after:opacity-40">
          <Image
            priority
            alt="Next.js Logo"
      ...
      <footer className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        <Link
          className="text-foreground group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 dark:hover:border-neutral-700 dark:hover:bg-neutral-800/30"
