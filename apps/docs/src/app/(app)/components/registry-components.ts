...
export const registryComponents: Record<string, RegistryItem> = {
  ...
  field: {
    component: dynamic(async () =>
      import("@/app/(app)/components/_components/field-demo").then((module_) => module_.FieldDemo),
    ),
    description: "Field",
    slug: "field",
    title: "Field",
  ...
  "input-group": {
    component: dynamic(async () =>
      import("@/app/(app)/components/_components/input-group-demo").then(
        (module_) => module_.InputGroupDemo,
      ),
    ),
