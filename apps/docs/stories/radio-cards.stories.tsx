  ...
  render: (args) => (
    <Box>
      <RadioCards defaultValue="1" className="grid-cols-1 sm:grid-cols-3" {...args}>
        <RadioCardsItem value="1" className="hover:bg-accent hover:text-accent-foreground">
          <Box className="flex w-full flex-col items-start">
            <Text className="font-bold">8-core CPU</Text>
            <Text>32GB RAM</Text>
          </Box>
        </RadioCardsItem>
        <RadioCardsItem value="2" className="hover:bg-accent hover:text-accent-foreground">
          <Box className="flex w-full flex-col items-start">
            <Text className="font-bold">6-core CPU</Text>
            <Text>24GB RAM</Text>
          </Box>
        </RadioCardsItem>
        <RadioCardsItem value="3" className="hover:bg-accent hover:text-accent-foreground">
          <Box className="flex w-full flex-col items-start">
