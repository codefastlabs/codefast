...
- [#866](https://github.com/codefastlabs/codefast/pull/866) [`57672b8`](https://github.com/codefastlabs/codefast/commit/57672b822e454fb610d319497163f0dce0862478) Thanks [@thevuong](https://github.com/thevuong)! - `BENCH_LIBRARY=<name,…>` restricts a run to the libraries named, by `libraryName` or `displayName`; a library-filtered
