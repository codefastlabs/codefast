...
const DI_FEATURES = {
  ...
  optional: "an unbound dependency resolves to undefined instead of throwing",
  ...
  "activation-hook": "a hook that sees each resolved instance before it is handed out",
