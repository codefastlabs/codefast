...
export const DI_COMPARISON_MARKDOWN: ComparisonMarkdownReportOptions = {
  documentHeading:
    "# @codefast/di vs inversify / awilix / tsyringe / brandi / ditox / iti / injection-js — benchmark report",
