...
export const buttonVariants = {
  ...
  variants: {
    ...
    variant: {
      ...
      glass: 'backdrop-blur-md bg-white/20 border border-white/30 text-white hover:bg-white/30 focus:ring-white/20',
      gradient:
      ...
      'gradient-blue':
        'bg-linear-to-r from-blue-500 to-cyan-500 text-white hover:from-blue-600 hover:to-cyan-600 focus:ring-blue-500/20',
      'gradient-green':
        'bg-linear-to-r from-green-500 to-emerald-500 text-white hover:from-green-600 hover:to-emerald-600 focus:ring-green-500/20',
      'gradient-orange':
        'bg-linear-to-r from-orange-500 to-red-500 text-white hover:from-orange-600 hover:to-red-600 focus:ring-orange-500/20',
