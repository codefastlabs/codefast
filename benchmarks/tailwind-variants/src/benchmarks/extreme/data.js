...
export const extremeTestProps = [
  ...
  { color: 'orange-500', disabled: true, elevation: 'inner', glass: true, rounded: 'none', size: 'size-20' },
  ...
  { active: false, color: 'fuchsia-600', disabled: false, elevation: 'lg', glass: true, loading: false },
  ...
  { color: 'neutral-400', disabled: true, elevation: 'sm', glass: false, shadow: 'sm', size: 'size-4' },
];
...
export const extremeSlotsVariants = {
  compoundSlots: [
    ...
    { className: 'animate-pulse cursor-wait', loading: true, slots: ['trigger', 'content', 'icon'] },
    { className: 'backdrop-blur-xl bg-white/10', glass: true, slots: ['content', 'header', 'footer', 'overlay'] },
    { className: 'text-xs p-1 gap-0.5', size: 'xs', slots: ['trigger', 'title', 'description', 'action'] },
    { className: 'text-sm p-2 gap-1', size: 'sm', slots: ['trigger', 'title', 'description', 'action'] },
    { className: 'text-base p-4 gap-2', size: 'md', slots: ['trigger', 'title', 'description', 'action'] },
    { className: 'text-lg p-6 gap-3', size: 'lg', slots: ['trigger', 'title', 'description', 'action'] },
    { className: 'text-xl p-8 gap-4', size: 'xl', slots: ['trigger', 'title', 'description', 'action'] },
    { className: 'rounded-none', rounded: 'none', slots: ['trigger', 'content', 'header', 'footer'] },
