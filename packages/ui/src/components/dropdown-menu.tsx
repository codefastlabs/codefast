...
type DropdownMenuCheckboxItemElement = React.ComponentRef<typeof DropdownMenuPrimitive.CheckboxItem>;
...
type DropdownMenuArrowElement = React.ComponentRef<typeof DropdownMenuPrimitive.Arrow>;
