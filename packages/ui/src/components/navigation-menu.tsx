...
const navigationMenuTriggerVariants = tv({
  base: buttonVariants({
    className: [
      ...
      "data-[state=open]:bg-secondary-hover data-[state=open]:text-secondary-foreground",
  ...
  return (
    <NavigationMenuPrimitive.Content
      className={cn(
        ...
        "data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 data-[motion^=from-]:animate-in data-[motion^=from-]:fade-in-0 data-[motion^=to-]:animate-out data-[motion^=to-]:fade-out-0",
  ...
  return (
    <div className={cn("absolute top-full left-0 z-30", "flex justify-center perspective-distant")}>
      <NavigationMenuPrimitive.Viewport
        className={cn(
          "relative mt-2 w-full origin-[top_center] overflow-hidden",
          "min-h-[calc(var(--radix-navigation-menu-viewport-height)+2px)] sm:min-w-[calc(var(--radix-navigation-menu-viewport-width)+2px)]",
          "rounded-lg border bg-popover text-popover-foreground shadow-lg",
          "transition-[width,height] ease-spring",
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative top-[60%]",
          "size-2.5 rotate-45 rounded-tl-xs",
