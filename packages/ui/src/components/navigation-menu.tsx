...
type NavigationMenuContentElement = React.ComponentRef<
...
type NavigationMenuViewportElement = React.ComponentRef<
...
type NavigationMenuIndicatorElement = React.ComponentRef<
