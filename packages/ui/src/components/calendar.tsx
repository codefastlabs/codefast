  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full p-0",
        ...
        dropdown_root: cn(
          "relative rounded-md border border-field-border shadow-xs",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-3 group-data-[focused=true]/day:ring-ring-focus",
