...
function InputOTPSlot({
  ...
  return (
    <div
      className={cn(
        'border-input data-[active=true]:ring-3 data-[active=true]:border-border-focus data-[active=true]:ring-ring not-has-disabled:shadow-xs outline-hidden relative flex size-10 items-center justify-center border text-sm transition-all first:rounded-l-lg last:rounded-r-lg data-[active=true]:z-10',
