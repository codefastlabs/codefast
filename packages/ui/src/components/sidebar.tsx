...
function SidebarRail({ className, ...props }: SidebarRailProps): JSX.Element {
  ...
  return (
    <button
      className={cn(
        "absolute z-20 hidden w-4",
        "inset-y-0",
        "-translate-x-1/2 transition-all ease-linear in-data-side-right:cursor-e-resize in-data-side-left:cursor-w-resize",
        ...
        "sm:flex",
        "[[data-side=left][data-collapsible=offcanvas]_&]:-right-2 [[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-collapsible=offcanvas]_&]:-left-2 [[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
        className,
      )}
      data-sidebar="rail"
...
function SidebarMenuSubButton({
  ...
  return (
    <Component
      className={cn(
        "flex h-7 min-w-0 items-center gap-2 overflow-hidden",
        "px-2",
        "rounded-md ring-sidebar-ring",
        "text-sidebar-foreground",
        "-translate-x-px outline-hidden",
        "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
        "focus-visible:ring-3",
        "active:bg-sidebar-accent active:text-sidebar-accent-foreground",
        "disabled:pointer-events-none disabled:opacity-50",
