...
function RadioGroupItem({ className, ...props }: ComponentProps<typeof RadioGroupPrimitive.Item>): JSX.Element {
  return (
    <RadioGroupPrimitive.Item
      className={cn(
        'border-input hover:not-disabled:not-aria-checked:border-input-hover focus-visible:ring-ring focus-visible:ring-3 aria-checked:border-primary aria-checked:bg-primary not-disabled:shadow-xs outline-hidden peer inline-flex size-4 shrink-0 items-center justify-center rounded-full border transition-[color,box-shadow,border-color,background-color] disabled:opacity-50',
        className,
      )}
