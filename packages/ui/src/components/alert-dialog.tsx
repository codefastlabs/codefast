...
type AlertDialogContentElement = ComponentRef<
...
type AlertDialogDescriptionElement = ComponentRef<
...
type AlertDialogActionElement = ComponentRef<
...
type AlertDialogCancelElement = ComponentRef<
