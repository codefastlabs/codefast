...
function InputNumber({
  ...
  return (
    <InputNumberPrimitive.Root
      ...
      className={cn(
        "group peer flex h-9 w-full grow items-center gap-3 rounded-lg border border-field-border bg-field px-3 pr-0 text-base transition not-has-disabled:shadow-xs focus-within:border-ring focus-within:ring-3 focus-within:ring-ring-focus hover:not-has-disabled:not-focus-within:border-field-border-hover has-disabled:opacity-50 has-aria-invalid:border-destructive focus-within:has-aria-invalid:ring-ring-error hover:not-has-disabled:not-focus-within:has-aria-invalid:border-destructive/60 md:text-sm [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&>svg]:text-muted-foreground",
        className,
      )}
    ...
    >
      <InputNumberPrimitive.Field
        ...
        autoComplete="off"
        autoCorrect="off"
        className="h-9 w-full min-w-0 rounded-md border border-field-border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none selection:bg-primary selection:text-primary-foreground file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring-focus disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-ring-error md:text-sm"
        spellCheck="false"
        {...props}
      />
      <div
