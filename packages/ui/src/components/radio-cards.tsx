...
function RadioCardsItem({ className, ...props }: ComponentProps<typeof RadioGroupPrimitive.Item>): JSX.Element {
  return (
    <RadioGroupPrimitive.Item
      className={cn(
        'border-secondary hover:not-disabled:bg-secondary focus-visible:ring-ring focus-visible:border-ring focus-visible:ring-3 aria-checked:border-primary group peer flex items-center justify-center rounded-lg border-2 p-4 focus-visible:outline-none disabled:opacity-50',
        className,
      )}
