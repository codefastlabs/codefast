...
const inputNumberVariants = tv({
  ...
  slots: {
     ...
     */
    field:
      "h-full min-w-0 flex-1 bg-transparent px-3 py-1 outline-none selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed",
    /**
     * Outer container.
     */
