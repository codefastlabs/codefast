...
export function AppLogoIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      {/* Bar 1 — short */}
      <rect fill="url(#bh-logo-g3)" height="6" rx="1.2" width="4.5" x="0" y="16" />
      {/* Bar 2 — medium */}
      <rect fill="url(#bh-logo-g2)" height="11" rx="1.2" width="4.5" x="7.5" y="11" />
      {/* Bar 3 — tall, bright */}
      <rect fill="url(#bh-logo-g1)" height="17" rx="1.2" width="4.5" x="15" y="5" />
      {/* Peak glow — outer halo */}
...
export function RefreshCwIcon({ className, ...props }: IconProps) {
  return (
    <Icon className={className} {...props}>
...
export function ZoomResetIcon({ className, ...props }: IconProps) {
  return (
    <Icon className={className} {...props}>
...
export function Grid2x2Icon({ className, ...props }: IconProps) {
  return (
    <Icon className={className} {...props}>
...
export function CommandIcon({ className, ...props }: IconProps) {
  return (
    <Icon className={className} {...props}>
