...
import { collectUnconditionalTailwindLiteralsFromCnArguments } from "#lib/arrange/domain/ast/collectors-cn";
 ...
 * Lives in infra because parsing uses the TypeScript-backed translator.
 */
