...
import {
  ...
  DomainSyntaxKind,
  type DomainArrayLiteralExpression,
  type DomainAsExpression,
  type DomainAstNode,
  type DomainBinaryExpression,
  type DomainCallExpression,
  type DomainConditionalExpression,
  type DomainExpressionStatement,
  type DomainIdentifier,
  type DomainImportClause,
  type DomainImportDeclaration,
  type DomainImportSpecifier,
  type DomainJsxAttribute,
  type DomainJsxExpression,
  type DomainNamedImports,
  type DomainNamespaceImport,
  type DomainNoSubstitutionTemplateLiteral,
  type DomainNonNullExpression,
  type DomainObjectLiteralExpression,
  type DomainParenthesizedExpression,
  type DomainPropertyAccessExpression,
  type DomainPropertyAssignment,
  type DomainSatisfiesExpression,
