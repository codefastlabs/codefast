...
import type { ArrangeGroupFileOptions, GroupFileResult } from "#lib/arrange/domain/types";
import {
...
import { printGroupFilePreviewFromWork } from "#lib/arrange/application/group-file-preview";
