import { APPLY_MIN_TOKENS, MAX_OBJECT_DEPTH } from "#/domains/arrange/domain/constants.domain";
import {
...
} from "#/domains/arrange/domain/ast/collectors-cn.collector";
import type { StringNode, TailwindClassLiteral } from "#/domains/arrange/domain/types.domain";
