...
describe("AWSCloudFrontLoader", () => {
  const loader = new AWSCloudFrontLoader();
  ...
  describe("canHandle", () => {
    it("should handle *.cloudfront.net URLs", () => {
      expect(loader.canHandle("https://d123456789.cloudfront.net/image.jpg")).toBe(true);
      expect(loader.canHandle("https://my-distribution.cloudfront.net/path/image.jpg")).toBe(true);
    });
    ...
    it("should not handle URLs without protocol", () => {
      expect(loader.canHandle("d123456789.cloudfront.net/image.jpg")).toBe(false);
    });
  });

  describe("load", () => {
    it("should transform AWS CloudFront URLs with width and quality", () => {
      const result = loader.load({
        quality: 80,
        src: "https://d123456789.cloudfront.net/image.jpg",
        width: 800,
      });
    ...
    it("should preserve existing query parameters", () => {
      const result = loader.load({
        quality: 90,
        src: "https://d123456789.cloudfront.net/image.jpg?existing=param",
        width: 600,
      });
    ...
    it("should handle URLs with paths", () => {
      const result = loader.load({
        quality: 85,
        src: "https://d123456789.cloudfront.net/path/to/image.jpg",
        width: 1200,
      });
