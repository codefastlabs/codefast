...
describe("loaders/index exports", () => {
  ...
  describe("loader functionality", () => {
    it("should export loaders that can handle their respective CDN URLs", () => {
      ...
      expect(
        cloudinaryLoader.canHandle("https://res.cloudinary.com/demo/image/upload/sample.jpg"),
      ).toBe(true);
      expect(imgixLoader.canHandle("https://demo.imgix.net/sample.jpg")).toBe(true);
      expect(
        supabaseLoader.canHandle(
      ...
      expect(awsLoader.canHandle("https://res.cloudinary.com/demo/image/upload/sample.jpg")).toBe(
        false,
      );
