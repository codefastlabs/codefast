...
14. [Đối chiếu với InversifyJS v8](#14-đối-chiếu-với-inversifyjs-v8)
...
### 8.4 `SyncModule` không thể import `AsyncModule`
...
Tất cả error subclasses với `readonly code` và context fields đầy đủ như section 9. Bao gồm `AmbiguousBindingError`, `AsyncDeactivationError`, `DisposedContainerError` mới.
...
### 13.1 Isolated container — không load module
...
### 13.2 Child container — override binding từ parent
...
### 13.3 Rebind — override binding trong cùng container
...
## 14. Đối chiếu với InversifyJS v8
...
### 14.1 Bảng so sánh API theo nhóm
...
### 14.3 Tổng hợp: cải thiện hơn v8
...
_Phiên bản tài liệu: 8.0 — April 2026_
