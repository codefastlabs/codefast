...
describe("Real-World Type Inference Tests", () => {
  ...
  test("should infer types for toggle component with boolean variants in real usage", () => {
    const toggleVariants = tv({
      base: "data-[state=unchecked]:bg-input relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary",
      defaultVariants: {
        disabled: false,
        size: "default",
      },
  ...
  test("should infer types for pagination with compound slots in real usage", () => {
    const paginationVariants = tv({
      ...
      slots: {
        ...
        item: "relative inline-flex items-center justify-center text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
        next: "relative inline-flex items-center justify-center text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
        prev: "relative inline-flex items-center justify-center text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
      },
      variants: {
        size: {
          default: {
        ...
        variant: {
          ...
          outline: {
            item: "border-input border hover:bg-accent hover:text-accent-foreground",
            next: "border-input border hover:bg-accent hover:text-accent-foreground",
            prev: "border-input border hover:bg-accent hover:text-accent-foreground",
          },
        },
      },
    });
