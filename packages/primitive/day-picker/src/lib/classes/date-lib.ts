...
export class DateLib {
   ...
   */
  differenceInCalendarDays: typeof differenceInCalendarDays = (dateLeft, dateRight) => {
   ...
   */
  differenceInCalendarMonths: typeof differenceInCalendarMonths = (dateLeft, dateRight) => {
  ...
  /**
   * Returns at the end of the month for the given date.
   *
   * @param date - The original date.
  ...
  /**
   * Returns at the end of the week for the given date.
   *
   * @param date - The original date.
  ...
  endOfWeek: typeof endOfWeek = <DateType extends Date, ResultDate extends Date = DateType>(
    ...
    return this.overrides?.endOfWeek
      ? this.overrides.endOfWeek(date, this.options as EndOfWeekOptions<ResultDate>)
  ...
  startOfWeek: typeof startOfWeek = <DateType extends Date, ResultDate extends Date = DateType>(
    ...
    return this.overrides?.startOfWeek
      ? this.overrides.startOfWeek(date, this.options as StartOfWeekOptions<ResultDate>)
