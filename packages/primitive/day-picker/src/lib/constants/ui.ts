...
export enum UI {
  ...
  /**
   * The grid cell with the day's date. Extended by {@link DayFlag} and {@link SelectionState}.
   */
  Day = 'day',
...
/**
 * The state that can be applied to the {@link UI.Day} element when in selection mode.
 */
