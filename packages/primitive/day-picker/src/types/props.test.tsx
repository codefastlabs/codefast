...
const Test = () => {
  return (
    <>
      ...
      <DayPicker mode="single" required onSelect={(date: Date | undefined) => {}} />
      ...
      <DayPicker mode="multiple" required selected={[]} onSelect={(date: Date[]) => {}} />
      <DayPicker mode="single" selected={new Date()} />
      <DayPicker modifiers={{ selected: new Date() }} onDayClick={() => {}} />
      <DayPicker onSelect={() => {}} selected={new Date()} onDayClick={() => {}} />
    </>
  );
};
