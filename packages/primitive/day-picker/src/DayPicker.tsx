...
import type { ChangeEventHandler, MouseEvent, FocusEvent, KeyboardEvent } from 'react';
              ...
              >
                ...
                >
                  {captionLayout?.startsWith('dropdown') ? (
                    ...
                    <components.CaptionLabel className={classNames[UI.CaptionLabel]} role="status" aria-live="polite">
